...
const MeetingList: React.FC<Props> = ({ data, index }) => {
    ...
    return (
        <Link key={index} className='card border card-main border-2 w-lg-325px w-xl-325px w-xxl-350px card-shadow mb-md-2 me-md-2 mb-5 me-5' to={'enrolled/' + data.id}>
            ...
            <div className='card-body py-0'>
                <div className='d-flex flex-wrap mt-1 mb-3'>
                    <div className='d-flex min-w-125px align-items-center py-2 me-7'>
                        <KTSVG
                ...
                <div className='d-flex justify-content-between flex-wrap mb-3 min-w-125px mb-3 pb-5'>
                    ...
                    </div>
                    {
                        ...
                        (<button
                            ...
                            type='button'
                            disabled={verifyJoiningTimeInstructor(data.start_time) ? false : true}
